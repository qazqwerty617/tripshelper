...
WHISPER_PROMPT = "BLUESEA, Globales, AzuLine, HSM, BJ Playamar, Iberostar, Rixos, готель, євро, дорослих, Тенеріфе, Майорка, Коста-Брава."
...
4. НЕ видаляй жодної цифри (вік дітей, кількість ночей, дати, ціни). 
"""
