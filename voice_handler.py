...
WHISPER_PROMPT = "Тенеріфе, Майорка, Коста-Брава, Iberostar, Rixos, Mitsis, Grecotel, Sol, Melia, HSM, Azuline, BJ, Playamar, Riu, Barcelo, готель, дорослих, ночей, євро."

# Prompt for cleaning up voice transcription
VOICE_CLEANUP_PROMPT = """Ти — коректор туристичних текстів. Твоє завдання: виправити помилки розпізнавання голосу (особливо в назвах готелів), але ЗБЕРЕГТИ ВСІ ДАНІ. 

ПРАВИЛА:
1. Виправ транслітерацію брендів (наприклад: "ріксос" -> "Rixos", "блю сі" -> "Blue Sea", "іберостар" -> "Iberostar"). 
2. КРИТИЧНО: НЕ видаляй і НЕ скорочуй жодної цифри! Ціни, дати, кількість людей, вік дітей, кількість ночей мають залишитися в тексті слово в слово. 
3. НЕ роби переказ тексту. Збережи оригінальну структуру та порядок думок менеджера.
"""
