...
ПРАВИЛА:
1. Використовуй ТІЛЬКИ назви з наданого "СПИСКУ ГОТЕЛІВ НАПРЯМКУ", якщо є хоча б мінімальна схожість.
...
4. СТРОГИЙ ЛІМІТ: Якщо менеджер назвав 11 готелів — у списку має бути РІВНО 11 готелів. Не додавай зайвого, не дублюй назви, не вигадуй готелі від себе.
5. ФОРМАТ: Тільки JSON {"hotels": ["Name 1", "Name 2"]}. Жодного іншого тексту.

КРИТИЧНО: Будь ласка, будь дуже уважним до кількості. Зайві готелі в підбірці — це груба помилка.
"""
...
ПРАВИЛА:
- Виправляй лише явну "кашу" в словах (наприклад "Тенер і Фе" -> "Тенерифе").
- НЕ ВИДАЛЯЙ назви готелів, навіть якщо вони звучать дивно.
- НЕ ДОДАВАЙ нічого від себе.
- НЕ ЗМІНЮЙ кількість згаданих об'єктів.
