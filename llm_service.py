...
2. НЕ ЗАМІНЮЙ ГОТЕЛІ на інші, якщо не впевнений у назві.
3. НЕ ПРОПУСКАЙ ГОТЕЛІ. Якщо менеджер назвав готель, якого немає в списку — спробуй знайти максимально схожий за звучанням у цьому списку. Якщо немає нічого схожого — поверни ТУ САМУ ідентичну назву, яку надав менеджер.
4. ПОРЯДОК ТА КІЛЬКІСТЬ: Повертай готелі рівно в тому порядку, в якому вони йдуть у тексті. 
5. СТРОГИЙ ЛІМІТ: Якщо менеджер назвав 11 готелів — у списку має бути РІВНО 11 готелів. Не додавай зайвого.
6. ФОРМАТ: Тільки JSON {"hotels": ["Name 1", "Name 2"]}. Жодного іншого тексту.

КРИТИЧНО: Будь ласка, будь дуже уважним до назв. Ти МАЄШ вибрати готель із наданого списку, якщо він там є. Якщо його там немає — пиши назву як у менеджера.
"""
